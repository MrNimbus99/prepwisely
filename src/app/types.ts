export type PageName = 
  ...
  | 'article-ai-practitioner'
  | 'article-cloud-practitioner'
  | 'article-solutions-architect-associate'
  | 'article-developer-associate'
  | 'article-sysops-administrator'
  | 'article-data-engineer'
  | 'article-ml-engineer'
  | 'article-solutions-architect-professional'
  | 'article-devops-engineer'
  | 'article-genai-developer'
  | 'article-security-specialty'
  | 'article-ml-specialty'
